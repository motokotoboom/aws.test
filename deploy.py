...
if __name__ == "__main__":
    ...
    if command == 'batch':
        ...
        response = ec2.executeSsh(instance,'sudo mkfs -t ext4 /dev/xvdb >/dev/null 2>&1;sudo mount -t auto /dev/xvdb /mnt >/dev/null 2>&1;cd /mnt/;sudo git clone https://github.com/motokotoboom/aws.test.git >/dev/null 2>&1; date>>/tmp/date2.txt; cd /mnt/aws.test;./start.sh ')
